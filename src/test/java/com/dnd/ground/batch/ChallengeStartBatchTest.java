...
@SpringBatchTest
@SpringBootTest(classes = {ChallengeStartBatch.class, BatchTestConfig.class, UserChallengeRepository.class, ChallengeRepository.class})
@ActiveProfiles("local")
public class ChallengeStartBatchTest {
    @Autowired
    @Qualifier("challenge_start_job")
    Job challenge_start_job;
